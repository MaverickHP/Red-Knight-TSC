...
contract RedKnightToken is IERC20, Ownable {
    ...
    // Base fees
	function setBaseFeesOnBuy(uint256 _liquidityFeeOnBuy,  uint256 _marketingFeeOnBuy, uint256 _devFeeOnBuy,  uint256 _buyBackFeeOnBuy, uint256 _holdersFeeOnBuy) external onlyOwner {
	...
	function setBaseFeesOnSell(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _devFeeOnSell, uint256 _buyBackFeeOnSell, uint256 _holdersFeeOnSell) external onlyOwner {
    ...
    //Launch2 Fees
	function setLaunch2FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _devFeeOnBuy,  uint256 _buyBackFeeOnBuy, uint256 _holdersFeeOnBuy) external onlyOwner {
	...
	function setLaunch2FeesOnSell(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _devFeeOnSell, uint256 _buyBackFeeOnSell, uint256 _holdersFeeOnSell) external onlyOwner {
	...
	//Launch3 Fees
	function setLaunch3FeesOnBuy(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _devFeeOnBuy, uint256 _buyBackFeeOnBuy, uint256 _holdersFeeOnBuy) external onlyOwner {
	...
	function setLaunch3FeesOnSell(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _devFeeOnSell, uint256 _buyBackFeeOnSell,  uint256 _holdersFeeOnSell) external onlyOwner {
	...
	function _swapAndLiquify() private {
        ...
        uint256 marketingFeePrior = _marketingFee;
